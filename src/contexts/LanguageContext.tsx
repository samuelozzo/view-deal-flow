...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    whyViewDealWorks: "Why ViewDeal Works",
    ...
    creatorJourneyDesc: "From discovering opportunities to getting paid - here's how creators succeed on ViewDeal.",
    step: "Step",
    ...
    trustSecurityDesc: "ViewDeal protects both creators and businesses with industry-leading security measures and transparent processes.",
    ...
    faqAnswer3: "Currently, ViewDeal supports TikTok, Instagram, and YouTube for view verification.",
    ...
    faqQuestion5: "Is ViewDeal available outside the EU?",
    faqAnswer5: "Currently, ViewDeal operates exclusively within the European Union to ensure compliance with EU regulations.",
  },
  it: {
    // Navbar
    ...
    whyViewDealWorks: "Perché ViewDeal Funziona",
    ...
    creatorJourneyDesc: "Dalla scoperta delle opportunità fino al pagamento - ecco come i creator hanno successo su ViewDeal.",
    step: "Passo",
    ...
    trustSecurityDesc: "ViewDeal protegge sia creator che aziende con misure di sicurezza leader del settore e processi trasparenti.",
    ...
    faqAnswer3: "Attualmente, ViewDeal supporta TikTok, Instagram e YouTube per la verifica delle visualizzazioni.",
    ...
    faqQuestion5: "ViewDeal è disponibile fuori dall'UE?",
    faqAnswer5: "Attualmente, ViewDeal opera esclusivamente all'interno dell'Unione Europea per garantire la conformità alle normative UE.",
  },
  es: {
    // Navbar
    ...
    whyViewDealWorks: "Por Qué ViewDeal Funciona",
    ...
    creatorJourneyDesc: "Desde descubrir oportunidades hasta recibir el pago - así es como los creadores tienen éxito en ViewDeal.",
    step: "Paso",
    ...
    trustSecurityDesc: "ViewDeal protege tanto a creadores como a empresas con medidas de seguridad líderes en la industria y procesos transparentes.",
    ...
    faqAnswer3: "Actualmente, ViewDeal admite TikTok, Instagram y YouTube para la verificación de vistas.",
    ...
    faqQuestion5: "¿ViewDeal está disponible fuera de la UE?",
    faqAnswer5: "Actualmente, ViewDeal opera exclusivamente dentro de la Unión Europea para garantizar el cumplimiento de las regulaciones de la UE.",
  },
};
